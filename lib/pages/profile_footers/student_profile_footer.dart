...
class StudentFooter extends StatefulWidget {
  final String userUID;

  const StudentFooter({Key? key, required this.userUID}) : super(key: key);

  @override
  _StudentFooterState createState() => _StudentFooterState();
}

class _StudentFooterState extends State<StudentFooter> {
  int selectedTab = 0;
